...
class _SplashScreenState extends State<SplashScreen> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    // Keep splash showing for 5 seconds then navigate to welcome/onboarding
    ...
    return Scaffold(
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ScaleTransition(scale: _scaleAnim, child: ClipRRect(borderRadius: BorderRadius.circular(16), child: logo)),
                ...
                children: [
                  Text(
                    ...
                    style: GoogleFonts.poppins(
                      ...
                      letterSpacing: 0.4,
                      shadows: [Shadow(color: Colors.black.withOpacity(0.18), blurRadius: 4, offset: const Offset(0, 2))],
                    ),
                  ),
                  ...
                  _GradientText(
                    ...
                    gradient: const LinearGradient(colors: [Color(0xFFFFB86B), Color(0xFFD97706)]),
                    style: GoogleFonts.poppins(fontSize: 36, fontWeight: FontWeight.w900, letterSpacing: 0.6),
                  ),
                  const SizedBox(width: 8),
                  Text(
                    'NSTU',
